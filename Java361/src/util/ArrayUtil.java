...
public class ArrayUtil {
 ...
 // 1. int[] 기준
    ...
    public static int[] add(int[] array, int index, int element) {
        ...
        // 2. for문을 사용하여
        // array의 0번 인덱스부터 index 전까지를 temp에 추가한다.
    ...
    // B. 현재 배열이 비어있는 배열인지 확인해주는
    public static boolean isEmpty(String[] array) {
        return size(array) == 0;
    }

    // C. 해당 배열의 특정 인덱스의 값을 리턴하는
    public static String get(String[] array, int index) {
        return array[index];
    }

    // D. 해당 배열에 특정 값이 존재하는지 확인해주는 
    ...
    // E. 해당 배열에 특정 값의 가장 먼저 등장하는 인덱스가 몇번인지 찾아주는 
    // 단, 해당 값이 존재하지 않으면 -1이 리턴된다.
