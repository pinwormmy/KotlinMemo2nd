...
public class MemberController{
    ...
    public static void signUp() {        
        ...
        while(true) {
            ...
            if(MovieModel.CheckDuplicatedId(userId, MainController.memberList)) 
        ...
        while(true) {
            ...
            if(MovieModel.CheckDuplicatedId(userId, MainController.memberList)) {
                while(true) {
                    ...
                    if(MovieModel.CheckPassword(userId, userPassword, MainController.memberList)) {
                        System.out.println("로그인 성공! 환영합니다.");
                        
                        return MovieModel.loginUserData(userId, MainController.memberList);
                    }
                    else
