...
public class RentCarController {
    ...
    public static void deleteScreen(TheaterDTO theater) {
        ...
        while(true) {
            ...
            if(question.equalsIgnoreCase("y")) {
                MainController.screenList.remove(screen);
                break;
            }
    ...
    public static void modifyScreen(TheaterDTO theater) {
        ...
        while(true) {
            MovieView.showMovieList(MainController.movieList);
    ...
    public static void addScreen(TheaterDTO theater) {
        ...
        screen.setScreenNumber(MainController.screenNumberSet++);
        ...
        MainController.screenList.add(screen);
