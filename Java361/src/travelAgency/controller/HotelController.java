...
public static void addGrade(MovieDTO movie) {
        ...
        grade.setGradeNumber(MainController.gradeNumberSet++);
        grade.setMemberNumber(MainController.memberDTO.getUserNumber());
        ...
        if(MovieModel.searchAddedGrade(movie.getMovieNumber()) == true) {
            ...
            grade = MovieModel.searchAddedGrade(movie.getMovieNumber(), MainController.memberDTO);
        }
        ...
        if(MovieModel.searchAddedGrade(movie.getMovieNumber()) == true) {}        
            ...
            MainController.gradeList.add(grade);
        
        
        
        if(MainController.memberDTO.getUserLevel() == 1) {
