...
public class AirlineController {
    ...
    static void manageTheater() { 
        ...
        while(true) {
            ...
            MovieView.showTheaterList(MainController.theaterList);
            
            int selectMenu = Util.scanInt("1.영화관 조회 2.영화관 등록 9.메인으로");
            
            switch(selectMenu) {
            case 1:
                selectTheaterInfo(MainController.theaterList);
                break;
            case 2:
                addTheater();
                break;           
    ...
    private static void addTheater() {
        ...
        theater.setTheaterNumber(MainController.theaterNumberSet++);
        theater.setTheatherLocation(Util.scanString("주소"));
        theater.setTheaterPhone(Util.scanString("연락처"));
        
        MainController.theaterList.add(theater);
    ...
    private static void selectTheaterInfo(List<TheaterDTO> theaterList) {
        ...
        while(true) {
            ...
            if(MainController.theaterNumberSet == 1) {
...
public static void deleteTheater(TheaterDTO theater) {
        ...
        while(true) {
            ...
            if(question.equalsIgnoreCase("y")) {
                MainController.theaterList.remove(theater);
                break;
            }
