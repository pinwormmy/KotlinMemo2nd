...
// 비만도 계산 프로그램에서 입력값 검증 추가

import java.util.Scanner;

public class Ex04BmiChecker2 {
    public static void main(String[] args) {
        ...
        if(age < 0) {
            System.out.println("나이 입력 오류. 프로그램 종료");
        }else {
            ...
            if(height < 0 || height > 2.80) {
                System.out.println("신장 입력 오류. 프로그램 종료");
                ...
                if(weight < 0 || weight > 635) {
                    System.out.println("몸무게 입력 오류. 프로그램 종료");
                }
                else {
                    // 출력
                    // 이름: ### 나이: 0##세 출력
